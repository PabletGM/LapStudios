...
#include "LAPSTUDIOSSuegraCharacter.generated.h"
...
UCLASS(config = Game)
class ALAPSTUDIOSSuegraCharacter : public ACharacter
{
    GENERATED_BODY()
...
protected:
    ...
    // Timer handle for reverting movement inversion
    ...
    float GetRandomFloatBetween10And45();
